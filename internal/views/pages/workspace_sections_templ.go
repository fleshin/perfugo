...
func IngredientManagement(snapshot WorkspaceSnapshot) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<section class=\"space-y-8\" data-module=\"ingredients\" data-module-key=\"ingredients\"><div class=\"grid gap-6 lg:grid-cols-3\"><div class=\"lg:col-span-2 space-y-6 rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-8 shadow-[0_30px_70px_rgba(0,0,0,0.35)] backdrop-blur-xl workspace-surface\"><header class=\"flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between\"><div><h3 class=\"text-lg workspace-heading\">Formula Ingredient</h3><p class=\"text-sm uppercase tracking-[0.4em] workspace-subtle\">Mock CRUD powered by the in-memory database.</p></div><span class=\"rounded-full border border-white/15 px-4 py-2 text-[0.6rem] uppercase tracking-[0.45em] workspace-subtle\">Mock DB Active</span></header><form class=\"grid gap-5 md:grid-cols-2\" data-action=\"create\"><label class=\"space-y-2 text-[0.65rem] uppercase tracking-[0.45em] workspace-muted\">Formula <select name=\"formulaId\" required data-formula-select class=\"w-full rounded-2xl border border-white/15 bg-black/40 px-4 py-3 text-sm workspace-heading focus:border-white/40 focus:outline-none\"></select></label> <label class=\"space-y-2 text-[0.65rem] uppercase tracking-[0.45em] workspace-muted\">Aroma Chemical <select name=\"aromaChemicalId\" required data-chemical-select class=\"w-full rounded-2xl border border-white/15 bg-black/40 px-4 py-3 text-sm workspace-heading focus:border-white/40 focus:outline-none\"></select></label> <label class=\"space-y-2 text-[0.65rem] uppercase tracking-[0.45em] workspace-muted\">Amount <input type=\"number\" step=\"0.01\" min=\"0\" name=\"amount\" required placeholder=\"12.5\" class=\"w-full rounded-2xl border border-white/15 bg-black/40 px-4 py-3 text-sm workspace-heading placeholder:text-white/30 focus:border-white/40 focus:outline-none\"></label> <label class=\"space-y-2 text-[0.65rem] uppercase tracking-[0.45em] workspace-muted\">Unit <select name=\"unit\" class=\"w-full rounded-2xl border border-white/15 bg-black/40 px-4 py-3 text-sm workspace-heading focus:border-white/40 focus:outline-none\"><option value=\"g\">g</option> <option value=\"kg\">kg</option> <option value=\"ml\">ml</option> <option value=\"L\">L</option></select></label><div class=\"md:col-span-2 flex flex-wrap items-center justify-end gap-3\"><button type=\"reset\" class=\"rounded-full border border-white/15 px-6 py-2 text-[0.65rem] uppercase tracking-[0.45em] workspace-muted transition hover:border-white/30 hover:text-white\">Reset</button> <button type=\"submit\" class=\"rounded-full bg-white px-6 py-2 text-[0.65rem] uppercase tracking-[0.45em] text-[#050509] shadow-[0_18px_45px_rgba(255,255,255,0.22)] transition hover:bg-white/90\">Add Ingredient</button></div></form></div><aside class=\"space-y-4 rounded-3xl border border-white/10 bg-black/35 p-6 text-sm workspace-muted backdrop-blur-xl workspace-surface-soft\"><h4 class=\"text-base workspace-heading\">Workspace Snapshot</h4><p>The mock connection ships with curated data: ")
		if templ_7745c5c3_Err != nil {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 82, Col: 104}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 82, Col: 151}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 82, Col: 201}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var4))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, " aroma chemicals.</p><p>All mutations stay on the client so you can preview flows without touching production services.</p></aside></div><div class=\"rounded-3xl border border-white/10 bg-black/35 backdrop-blur-xl workspace-surface\"><header class=\"flex flex-col gap-3 px-6 pt-6 text-sm uppercase tracking-[0.45em] workspace-subtle sm:flex-row sm:items-center sm:justify-between\"><span>Ledger</span><div class=\"flex flex-col gap-3 sm:flex-row sm:items-center\"><input type=\"search\" data-filter-search placeholder=\"Search ingredient or formula\" class=\"w-full rounded-full border border-white/15 bg-black/40 px-4 py-2 text-xs workspace-heading placeholder:text-white/30 focus:border-white/40 focus:outline-none\"> <select data-filter-status class=\"rounded-full border border-white/15 bg-black/40 px-4 py-2 text-xs workspace-heading focus:border-white/40 focus:outline-none\"><option value=\"all\">All sources</option> <option value=\"Aroma Chemical\">Aroma chemical</option> <option value=\"Sub-Formula\">Sub-formula</option></select></div></header><div class=\"mt-4 overflow-hidden rounded-3xl border border-white/10\"><table class=\"min-w-full divide-y divide-white/10 text-left text-sm workspace-muted\"><thead class=\"bg-white/5 text-[0.6rem] uppercase tracking-[0.45em] workspace-subtle\"><tr><th class=\"px-5 py-4 font-medium\">Ingredient</th><th class=\"px-5 py-4 font-medium\">Formula</th><th class=\"px-5 py-4 font-medium\">Amount</th><th class=\"px-5 py-4 font-medium\">Updated</th><th class=\"px-5 py-4 font-medium\">Actions</th></tr></thead> <tbody data-list class=\"divide-y divide-white/10\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, ingredient := range snapshot.FormulaIngredients {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 111, Col: 83}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var5))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "\" class=\"bg-black/25 workspace-heading\"><td class=\"px-5 py-4\"><div class=\"font-medium workspace-heading\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 113, Col: 150}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var6))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "</div><div class=\"text-xs uppercase tracking-[0.35em] workspace-subtle\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 114, Col: 172}
			}
			...
			if ingredient.Formula != nil {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 118, Col: 105}
				}
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "<span class=\"workspace-subtle\">Formula #")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 120, Col: 142}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 123, Col: 146}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 124, Col: 136}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 127, Col: 144}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var12))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "\" class=\"rounded-full border border-white/20 px-4 py-2 text-[0.6rem] uppercase tracking-[0.45em] workspace-muted transition hover:border-white/40 hover:text-white\">Edit</button> <button type=\"button\" data-action=\"delete\" data-id=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 128, Col: 146}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, "</tbody></table><div data-empty-state class=\"hidden px-6 py-16 text-center text-sm workspace-muted\">No records yet. Add an ingredient above to populate the ledger.</div></div></div><div data-edit-panel class=\"fixed inset-0 z-40 hidden items-center justify-center bg-black/80 px-6 py-10 backdrop-blur\"><div class=\"w-full max-w-lg space-y-5 rounded-3xl border border-white/10 bg-[#0a0a10] p-8 shadow-[0_40px_120px_rgba(0,0,0,0.55)] workspace-surface\"><header class=\"flex items-center justify-between\"><div><h4 class=\"text-lg workspace-heading\">Edit Ingredient</h4><p class=\"text-sm workspace-muted\">Changes stay local to your browser session.</p></div><button type=\"button\" data-role=\"close-panel\" class=\"rounded-full border border-white/15 px-3 py-1 text-[0.55rem] uppercase tracking-[0.5em] workspace-subtle transition hover:border-white/30 hover:text-white\">Close</button></header><form class=\"space-y-4\" data-action=\"edit\"><input type=\"hidden\" name=\"id\"> <label class=\"space-y-2 text-[0.6rem] uppercase tracking-[0.45em] workspace-muted\">Formula <select name=\"formulaId\" required data-formula-select class=\"w-full rounded-2xl border border-white/15 bg-black/40 px-4 py-2 text-sm workspace-heading focus:border-white/40 focus:outline-none\"></select></label> <label class=\"space-y-2 text-[0.6rem] uppercase tracking-[0.45em] workspace-muted\">Aroma Chemical <select name=\"aromaChemicalId\" required data-chemical-select class=\"w-full rounded-2xl border border-white/15 bg-black/40 px-4 py-2 text-sm workspace-heading focus:border-white/40 focus:outline-none\"></select></label><div class=\"grid gap-4 sm:grid-cols-2\"><label class=\"space-y-2 text-[0.6rem] uppercase tracking-[0.45em] workspace-muted\">Amount <input type=\"number\" step=\"0.01\" min=\"0\" name=\"amount\" class=\"w-full rounded-2xl border border-white/15 bg-black/40 px-4 py-2 text-sm workspace-heading focus:border-white/40 focus:outline-none\"></label> <label class=\"space-y-2 text-[0.6rem] uppercase tracking-[0.45em] workspace-muted\">Unit <select name=\"unit\" class=\"w-full rounded-2xl border border-white/15 bg-black/40 px-4 py-2 text-sm workspace-heading focus:border-white/40 focus:outline-none\"><option value=\"g\">g</option> <option value=\"kg\">kg</option> <option value=\"ml\">ml</option> <option value=\"L\">L</option></select></label></div><div class=\"flex justify-end gap-3\"><button type=\"button\" data-role=\"close-panel\" class=\"rounded-full border border-white/15 px-5 py-2 text-[0.6rem] uppercase tracking-[0.45em] workspace-muted transition hover:border-white/30 hover:text-white\">Cancel</button> <button type=\"submit\" class=\"rounded-full bg-white px-6 py-2 text-[0.6rem] uppercase tracking-[0.45em] text-[#050509] shadow-[0_18px_50px_rgba(255,255,255,0.25)] transition hover:bg-white/90\">Save</button></div></form></div></div></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func FormulaManagement(snapshot WorkspaceSnapshot) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, formula := range snapshot.Formulas {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 259, Col: 80}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 261, Col: 122}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 262, Col: 150}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 264, Col: 104}
			}
			...
			if formula.ParentFormulaID != nil {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 274, Col: 135}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 279, Col: 112}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 280, Col: 133}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 283, Col: 141}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 284, Col: 143}
			}
...
func ReportsOverview(cards []ReportCard, timeline []ReportEvent, leaders []IngredientPerformance) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, card := range cards {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 343, Col: 119}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 344, Col: 103}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 345, Col: 93}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 346, Col: 118}
			}
		...
		for _, event := range timeline {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 357, Col: 83}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 358, Col: 104}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 360, Col: 101}
			}
		...
		for _, leader := range leaders {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 370, Col: 75}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 371, Col: 104}
			}
...
func PreferencesPanel(themeKey string, options []theme.Option) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		templ_7745c5c3_W, ctx := templ_7745c5c3_Input.Writer, templ_7745c5c3_Input.Context
		if templ_7745c5c3_CtxErr := ctx.Err(); templ_7745c5c3_CtxErr != nil {
			return templ_7745c5c3_CtxErr
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 51, "<section class=\"space-y-6\" data-module=\"preferences\" data-theme=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		var templ_7745c5c3_Var35 string
		templ_7745c5c3_Var35, templ_7745c5c3_Err = templ.JoinStringErrs(themeKey)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 382, Col: 82}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var35))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 52, "\"><div class=\"space-y-5 rounded-3xl border border-white/10 bg-black/35 p-6 backdrop-blur-xl workspace-surface\"><header class=\"flex flex-col gap-2 text-sm uppercase tracking-[0.4em] workspace-subtle\"><span>Studio Preferences</span><p class=\"text-xs normal-case workspace-muted\">Tweak notification, theme, and cadence defaults for the mock session.</p></header><form class=\"space-y-5\" data-action=\"preferences\"><div class=\"grid gap-4 md:grid-cols-2\"><label class=\"space-y-2 text-sm workspace-heading\"><span class=\"text-[0.6rem] uppercase tracking-[0.45em] workspace-subtle\">Notifications</span> <select class=\"w-full rounded-2xl border border-white/15 bg-black/40 px-4 py-2 text-sm workspace-heading focus:border-white/40 focus:outline-none\"><option>Product launches</option> <option>Compliance</option> <option>Inventory</option></select></label> <label class=\"space-y-2 text-sm workspace-heading\"><span class=\"text-[0.6rem] uppercase tracking-[0.45em] workspace-subtle\">Theme</span> <select name=\"theme\" class=\"w-full rounded-2xl border border-white/15 bg-black/40 px-4 py-2 text-sm workspace-heading focus:border-white/40 focus:outline-none\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, item := range options {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 402, Col: 90}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/pages/workspace_sections.templ`, Line: 406, Col: 77}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 58, "</select></label></div><div class=\"flex flex-wrap items-center justify-end gap-3\"><button type=\"submit\" class=\"rounded-full bg-white px-6 py-2 text-[0.6rem] uppercase tracking-[0.45em] text-[#050509] shadow-[0_15px_40px_rgba(255,255,255,0.25)] transition hover:bg-white/90\">Save Preferences</button> <span data-success class=\"hidden text-xs uppercase tracking-[0.45em] text-emerald-400\">Saved</span></div></form></div></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
